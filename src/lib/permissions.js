...
export const MODULES = [
  ...
  { key: 'sub-registry', ar: 'سجل المقاولين', en: 'Subcontractor Registry', group: 'subcontractors' },
  { key: 'sub-contracts', ar: 'عقود الباطن', en: 'Sub Contracts', group: 'subcontractors' },
  { key: 'sub-invoices', ar: 'مستخلصات مقاولي الباطن', en: 'Sub Invoices', group: 'subcontractors' },
  { key: 'sub-payments', ar: 'سداد مقاولي الباطن', en: 'Sub Payments', group: 'subcontractors' },
  { key: 'sub-penalties', ar: 'غرامات مقاولي الباطن', en: 'Sub Penalties', group: 'subcontractors' },
  // HR
...
export const APP_ROLES = {
  ...
  ACCOUNTANT: {
    ...
    modules: ['sales', 'client-payments', 'purchase-orders', 'purchase-requests', 'goods-receipts', 'expenses', 'supplier-invoices',
      ...
      'vat', 'reports', 'fiscal-years', 'fixed-assets', 'audit', 'payroll-runs', 'payroll-sheets', 'clients', 'suppliers',
  ...
  PROJECT_MANAGER: {
    ...
    modules: ['projects', 'project-workspace', 'contracts', 'sales', 'client-payments', 'boq', 'purchase-orders',
      'purchase-requests', 'goods-receipts', 'expenses', 'subcontractors',
      'sub-registry', 'sub-contracts', 'sub-invoices', 'sub-payments', 'sub-penalties',
      'reports', 'clients'],
  },
  PROCUREMENT: {
