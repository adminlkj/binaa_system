...
export default function BOQ() {
  ...
  const save = async () => {
    if (!form.projectId || !form.description)
      return toast.error(t('المشروع والوصف مطلوبان', 'Project and description required', lang));
    setSaving(true);
    try {
  ...
  return (
    <ModuleLayout
      title={t('جدول الكميات', 'Bill of Quantities', lang)}
          ...
          <Table>
            <TableHeader>
              <TableRow>
                ...
                {projectFilter === 'ALL' && <TableHead>{t('المشروع', 'Project', lang)}</TableHead>}
