...
export default function Contracts() {
  ...
  const remove = async () => {
    try {
      ...
      if (checks.some(list => list.length > 0)) {
        toast.error(t('لا يمكن حذف عقد عليه مستخلصات أو فواتير أو أوامر تغيير', 'Cannot delete a contract with linked billings, invoices or change orders', lang));
        return;
      }
  ...
  return (
    ...
    >
      ...
      <DocumentPreviewDialog open={!!preview} onOpenChange={(o) => !o && setPreview(null)} title={{ ar: 'عقد مشروع', en: 'Project Contract' }}>
