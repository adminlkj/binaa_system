...
export default function SubcontractorWorkspace() {
    ...
    return (
      <div className="p-4 md:p-6">
        <div className="flex flex-col items-center justify-center py-24 text-center">
          ...
          <h2 className="text-lg font-bold">{t('لم يتم اختيار مقاول', 'No subcontractor selected', lang)}</h2>
  ...
  const tabs = [
    ...
    { key: 'invoices', ar: 'المستخلصات والفواتير', en: 'Invoices', Icon: ReceiptText },
