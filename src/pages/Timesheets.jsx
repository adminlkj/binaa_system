          ...
          <Table>
            <TableHeader>
              <TableRow>
                ...
                <TableHead>{t('المشروع / الموقع', 'Project / Site', lang)}</TableHead>
      ...
      <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
        <DialogContent className="max-w-lg" dir={lang === 'ar' ? 'rtl' : 'ltr'}>
          ...
          <div className="grid grid-cols-2 gap-3 py-2">
            ...
            <div className="space-y-1"><Label>{t('المشروع / الموقع', 'Project / Site', lang)}</Label><Input value={form.projectName} onChange={e => setForm(f => ({ ...f, projectName: e.target.value }))} /></div>
