...
const TYPES = {
  ...
  PROJECT: { ar: 'مخزن مشروع', en: 'Project', color: 'bg-emerald-100 text-emerald-700' },
...
export default function Warehouses() {
  ...
  const save = async () => {
    ...
    if (form.type === 'PROJECT' && !form.projectId) return toast.error(t('اختر المشروع المرتبط بمخزن المشروع', 'Select the linked project', lang));
    setSaving(true);
    try {
          ...
          <Table>
            <TableHeader>
              <TableRow>
                ...
                <TableHead>{t('المشروع المرتبط', 'Linked Project', lang)}</TableHead>
          ...
          <div className="grid grid-cols-2 gap-3 py-2">
            ...
            {form.type === 'PROJECT' && (
              <div className="space-y-1 col-span-2">
                <Label>{t('المشروع المرتبط', 'Linked Project', lang)} *</Label>
            ...
            <div className="space-y-1 col-span-2"><Label>{t('مركز التكلفة', 'Cost Center', lang)}</Label><Input value={form.costCenter} onChange={e => set('costCenter', e.target.value)} /></div>
          </div>
          <DialogFooter>
